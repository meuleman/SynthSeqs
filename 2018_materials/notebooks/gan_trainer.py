...
def train(path, loss="hinge", one_dim=False, data_type="strong", **kwargs):
    ...
    dataloader, _ = data_helper.get_the_dataloaders(BS, weighted_sample=True, one_dim=one_dim, data_type=data_type)
